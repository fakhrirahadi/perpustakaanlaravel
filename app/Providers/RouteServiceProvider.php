...
class RouteServiceProvider extends ServiceProvider
{
    ...
    // Jangan lupa tambahkan properti $namespace di file RouteServiceProvider.php yang ada dalam folder app\Providers dan tambahkan sintak di sebelah atas method public function boot()
    protected $namespace = 'App\\Http\\Controllers';
